...
})->middleware(['auth', 'verified'])->name('dashboard')->middleware('can:Dashboard');
...
Route::put('/permission/{permission}/update', [PermissionController::class, 'update'])
    ->name('permission.update')->middleware('can:Edit Permission');
Route::delete('/permission/{permission}/destroy', [PermissionController::class, 'destroy'])
    ->name('permission.destroy')->middleware('can:Delete Permission');
